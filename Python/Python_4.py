...
# Тело цикла: 6.1 Выводить в консоль (“Step =”, count)
...
# Тело цикла:7.1 Выводить в консоль (“Step =”, count)
...
# Тело цикла: 9.1 Выводить в консоль (“Step =”, count)
...
# Тело цикла: 10.1 Вывести в консоль (‘Step =’, item)
print('*** Задание 10 ***')
...
# Тело цикла: 11.1 Вывести в консоль (‘Step =’, item)
# 	          11.2 Сделать if с условием, если item равен  5, то вывести в консоль
# 	          (‘Item =’, item).
# 	          11.3 Сделать if с условием, если item равен  10, то вывести в консоль
# 	          (‘Item =’, item).
# 	          11.4 Сделать if с условием, если item меньше 4, то вывести в консоль
# 	          (‘Item <’, item).
# 	          11.5 Сделать if с условием, если item больше или равно 27, то вывести
# 	          в консоль (‘Item >=’, item).
print('*** Задание 11 ***')
...
# Тело цикла: 12.1 Вывести в консоль (‘Step =’, item)
...
# 13. Сделать цикл for c переменной item который будет работать пока счётчик range
# досчитает от 0 до 20
# Тело цикла: 13.1 Вывести в консоль (‘Step =’, item)
